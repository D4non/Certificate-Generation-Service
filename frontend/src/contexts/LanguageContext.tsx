...
const translations: Translations = {
  ...
  eventsDescription: { ru: 'Управляйте мероприятиями вашей организации. Для каждого мероприятия вы можете загружать участников, выбирать шаблоны и генерировать сертификаты.', en: 'Manage your organization\'s events. For each event, you can upload participants, select templates, and generate certificates.' },
  createEvent: { ru: 'Создать мероприятие', en: 'Create Event' },
  noEvents: { ru: 'Пока нет мероприятий', en: 'No events yet' },
  createFirstEvent: { ru: 'Создайте первое мероприятие, чтобы начать работу', en: 'Create your first event to get started' },
  editEvent: { ru: 'Редактировать мероприятие', en: 'Edit Event' },
  eventName: { ru: 'Название мероприятия', en: 'Event Name' },
  eventDescription: { ru: 'Описание (необязательно)', en: 'Description (optional)' },
  eventDescriptionPlaceholder: { ru: 'Описание мероприятия', en: 'Event description' },
  save: { ru: 'Сохранить', en: 'Save' },
  create: { ru: 'Создать', en: 'Create' },
  eventCreated: { ru: 'Мероприятие создано', en: 'Event created' },
  eventUpdated: { ru: 'Мероприятие обновлено', en: 'Event updated' },
  eventDeleted: { ru: 'Мероприятие удалено', en: 'Event deleted' },
  confirmDelete: { ru: 'Вы уверены, что хотите удалить это мероприятие?', en: 'Are you sure you want to delete this event?' },
  enterEventName: { ru: 'Введите название мероприятия', en: 'Enter event name' },
  errorLoadingEvents: { ru: 'Ошибка при загрузке мероприятий', en: 'Error loading events' },
